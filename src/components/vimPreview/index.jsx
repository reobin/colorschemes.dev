...
<pre class="Background-${uuid}"><code><span class="jsStorageClass-${uuid}">const</span><span class="jsVariableDef-${uuid}"> randomHexColorCode </span><span class="jsOperator-${uuid}">=</span><span class="jsArrowFunction-${uuid}"> () </span><span class="jsArrowFunction-${uuid}">=&gt;</span><span class="jsFuncBraces-${uuid}"> {</span>
...
<span class="jsGlobalObjects-${uuid}">console</span><span class="jsDot-${uuid}">.</span><span class="jsFuncCall-${uuid}">log</span><span class="jsParens-${uuid}">(</span><span class="jsFuncCall-${uuid}">randomHexColorCode</span><span class="jsParens-${uuid}">())</span><span class="jsNoise-${uuid}">;</span></code></pre>
`
